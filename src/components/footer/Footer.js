...
const FooterBottom = () => {
  return (
    <div className="text-center pt-6 mt-6 border-t border-gray-700">
      <p>© 2024 Tino Project. All rights reserved.</p>
    </div>
  );
};
